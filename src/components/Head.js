...
const Head = () => {
  ...
  const getSearchSuggestions = async () => {
    ...
    return (
      <div className="grid grid-flow-col p-5 mx-5 cursor-pointer">
        ...
        <div className="col-span-10 ml-[150px]">
          <div>
            <input
              type="text"
              value={searchQuery}
              onChange={function (e) {
                ...
                setSearchClass(e.target.value.trim() !== "");
              }}
          ...
          <div
            className={
              "bg-white absolute w-1/3 py-2 px-2 rounded-lg border border-gray-100 " +
              (searchClass === true ? "block" : "hidden")
            }
          >
            <ul>
              {suggestions.map((s) => (
